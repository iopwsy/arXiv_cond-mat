[1]. [*Coexistence of superconductivity and excitonic pairing in a doped-biased double-layer system*](https://arxiv.org/abs/2511.16696 "Coexistence of superconductivity and excitonic pairing in a doped-biased double-layer system")

V. Apinyan, M. Sahakyan

arXiv:2511.16696v1 Announce Type: new 
...
[2]. [*Quasiparticle Variational Quantum Eigensolver*](https://arxiv.org/abs/2511.16721 "Quasiparticle Variational Quantum Eigensolver")

Saavanth Velury, Yuxuan Wang

arXiv:2511.16721v1 Announce Type: new 
...
[3]. [*Liouvillian topology and non-reciprocal dynamics in open Floquet chains*](https://arxiv.org/abs/2511.16742 "Liouvillian topology and non-reciprocal dynamics in open Floquet chains")

Florian Koch, Yu-Min Hu, Jan Carl Budich

arXiv:2511.16742v1 Announce Type: new 
...
[4]. [*Excited states from local effective Hamiltonians of matrix product states and their entanglement spectrum transition*](https://arxiv.org/abs/2511.16746 "Excited states from local effective Hamiltonians of matrix product states and their entanglement spectrum transition")

Denise Cocchiarella, Mingru Yang, Yueshui Zhang, Mari Carmen Ba\~nuls, Hong-Hao Tu, Yuhan Liu

arXiv:2511.16746v1 Announce Type: new 
...
[5]. [*Landau-Lifshitz-Bloch simulations of the magnetocaloric effect in continuous ferromagnetic-paramagnetic transitions*](https://arxiv.org/abs/2511.16756 "Landau-Lifshitz-Bloch simulations of the magnetocaloric effect in continuous ferromagnetic-paramagnetic transitions")

Luis M. Moreno-Ram\'irez, Luis S\'anchez-Tejerina, \'Oscar Alejos, Victorino Franco, V\'ictor Raposo

arXiv:2511.16756v1 Announce Type: new 
...
[6]. [*Tungsten doping-induced phase transition in CVD-grown MoS2 bilayers*](https://arxiv.org/abs/2511.16758 "Tungsten doping-induced phase transition in CVD-grown MoS2 bilayers")
...
arXiv:2511.16758v1 Announce Type: new 
...
[7]. [*Light-Induced Lattice Coherence and Emission Enhancement in PTM-Passivated CsSnI3 Perovskites*](https://arxiv.org/abs/2511.16770 "Light-Induced Lattice Coherence and Emission Enhancement in PTM-Passivated CsSnI3 Perovskites")

Thomas Y. Adams, Bruce Barrios, Michael Ziegenfus, Hui Cai, Sayantani Ghosh

arXiv:2511.16770v1 Announce Type: new 
...
[8]. [*Fabrication of A Dual Gated Mirror Symmetric Twisted Trilayer Graphene Device to Study Superconductivity*](https://arxiv.org/abs/2511.16784 "Fabrication of A Dual Gated Mirror Symmetric Twisted Trilayer Graphene Device to Study Superconductivity")

Ahmed Shaikh, Phanibhusan Singha Mahapatra, Eva Y. Andrei

arXiv:2511.16784v1 Announce Type: new 
...
[9]. [*Glass Viscosity Curvature from Constraint-Driven Actualization: A Physical Parity with the Vogel-Fulcher-Tammann Relation*](https://arxiv.org/abs/2511.16791 "Glass Viscosity Curvature from Constraint-Driven Actualization: A Physical Parity with the Vogel-Fulcher-Tammann Relation")

Debra S. Gavant, Christian E. Precker

arXiv:2511.16791v1 Announce Type: new 
...
[10]. [*Reentrant Landau Levels in a Dirac topological insulator*](https://arxiv.org/abs/2511.16806 "Reentrant Landau Levels in a Dirac topological insulator")
...
[12]. [*Breakdown of adiabaticity in topological quantum liquids*](https://arxiv.org/abs/2511.16818 "Breakdown of adiabaticity in topological quantum liquids")

Carola Ciaramelletti, Daniel Arrufat-Vicente, Simone Paganelli, Nicolo Defenu

arXiv:2511.16818v1 Announce Type: new 
Abstract: We study the temporal behavior of topological quantum fluids with strong long-range couplings under slow external perturbations, whose rate $\delta$ approaches the quasi-static limit $\delta\to 0$. As expected, due to strong long-range interactions, the system lies in the mean-field universality and the density of defects for drives across the quantum critical point is adiabatic $n_{\rm exc}\propto \delta^{2}$. However, if the drive is instead terminated precisely at the edge of the topological non-trivial phase, the number of generated excitations becomes extensive $n_{\rm exc}\propto O(1)$. This result fundamentally breaks the established universal behavior observed in local topological quantum fluids and demonstrates a novel mechanism for the breakdown of adiabaticity in fermionic systems with strong long-range interactions.



[13]. [*Glassy polymers' strain-hardening moduli scale with their statistical-segment volumes*](https://arxiv.org/abs/2511.16833 "Glassy polymers' strain-hardening moduli scale with their statistical-segment volumes")

Robert S. Hoy

arXiv:2511.16833v1 Announce Type: new 
Abstract: Using molecular dynamics simulations, we show that a widely-accepted theoretical prediction for glassy-polymeric strain hardening moduli ($G_R \propto \rho_e$, where $\rho_e$ is the entanglement density) fails badly for semiflexible polymers with $N_e \lesssim 4C_\infty$. By postulating that the length, energy and strain scales controlling $G_R$ are the Kuhn length $\ell_K$ and statistical segment length $b = \sqrt{\ell_0 \ell_K}$ (where $\ell_0$ is the backbone bond length), the intermonomer binding energy $u_0$, and the incremental elastic strain $S_{\rm c}$ required to activate Kuhn-segment-scale plastic rearrangements, we develop a scaling theory predicting that $G_R = S_{\rm c}(u_0/\ell_0^3) b^3$ in the athermal limit. This prediction agrees quantitatively (semi-quantitatively) with simulated $G_R$ values for both flexible and semiflexible polymer glasses subjected to athermal uniaxial-stress extension (constant-volume simple shear), over a range of $\ell_K/\ell_0$ that is wider than that spanned by real systems.



[14]. [*Zero-temperature dynamics of the spherical model with non-reciprocal interactions*](https://arxiv.org/abs/2511.16836 "Zero-temperature dynamics of the spherical model with non-reciprocal interactions")
...
arXiv:2511.16836v1 Announce Type: new 
...
[15]. [*Computer Simulation of Gel Formation in Colloidal Systems of Sticky Rods*](https://arxiv.org/abs/2511.16872 "Computer Simulation of Gel Formation in Colloidal Systems of Sticky Rods")

Johannes Krotz

arXiv:2511.16872v1 Announce Type: new 
...
[16]. [*Accelerated Materials Discovery through Cost-Aware Bayesian Optimization of Real-World Indentation Workflows*](https://arxiv.org/abs/2511.16930 "Accelerated Materials Discovery through Cost-Aware Bayesian Optimization of Real-World Indentation Workflows")

Vivek Chawla, Stephen Puplampu, Haochen Zhu, Philip D. Rack, Dayakar Penumadu, Sergei Kalinin

arXiv:2511.16930v1 Announce Type: new 
...
[17]. [*Energy-Dependent Magnetic Modifications in HOPG via Microbeam Scanning*](https://arxiv.org/abs/2511.16934 "Energy-Dependent Magnetic Modifications in HOPG via Microbeam Scanning")

Ram Kumar, Aditya H. Kelkar, Neeraj Shukla, Paras Poswal, Sheshmani Singh

arXiv:2511.16934v1 Announce Type: new 
...
[18]. [*Cusped Electrical Conductivity in Spin-1 Chiral Fermion Systems Arising from Multifold Band Degeneracy*](https://arxiv.org/abs/2511.16969 "Cusped Electrical Conductivity in Spin-1 Chiral Fermion Systems Arising from Multifold Band Degeneracy")

Risako Kikuchi, Junya Endo, Ai Yamakage

arXiv:2511.16969v1 Announce Type: new 
...
[19]. [*Giant Nonlinear Photon-Drag Currents in Centrosymmetric Moir\'e Bilayers*](https://arxiv.org/abs/2511.16987 "Giant Nonlinear Photon-Drag Currents in Centrosymmetric Moir\'e Bilayers")

Zhuocheng Lu, Zhuang Qian, Zhichao Guo, Likun Shi, Shi Liu, Hua Wang, Kai Chang

arXiv:2511.16987v1 Announce Type: new 
...
[20]. [*Pair scattering from time-modulated impurity in the Bose-Hubbard model*](https://arxiv.org/abs/2511.17032 "Pair scattering from time-modulated impurity in the Bose-Hubbard model")

Neda Ahmadi, Ameneh Sheikhan, Corinna Kollath

arXiv:2511.17032v1 Announce Type: new 
...
[21]. [*Unconventional Geometric Phase in Twisted Junction of Cuprates*](https://arxiv.org/abs/2511.17033 "Unconventional Geometric Phase in Twisted Junction of Cuprates")

Zhigang Song, Kai Chang

arXiv:2511.17033v1 Announce Type: new 
...
[24]. [*Electron Hydrodynamics: Viscosity Tensor and effects of a Magnetic field*](https://arxiv.org/abs/2511.17088 "Electron Hydrodynamics: Viscosity Tensor and effects of a Magnetic field")

Anubhav Srivastava, Subroto Mukerjee

arXiv:2511.17088v1 Announce Type: new 
...
[25]. [*A topological field-effect memristor*](https://arxiv.org/abs/2511.17090 "A topological field-effect memristor")

Manuel Meyer, Selena Barragan, Sergey Krishtopenko, Adriana Wolf, Monika Emmerling, Sebastian Schmid, Jean-Baptiste Rodriguez, Eric Tournie, Benoit Jouault, Gerald Bastard, Frederic Teppe, Victor Lopez-Richard, Ovidiu Lipan, Lukas Worschech, Sven H\"ofling, Fabian Hartmann

arXiv:2511.17090v1 Announce Type: new 
...
[26]. [*Effect of temperature and excitation power on down-conversion process in Tb3+/Yb3+-activated silica-hafnia glass-ceramic films*](https://arxiv.org/abs/2511.17114 "Effect of temperature and excitation power on down-conversion process in Tb3+/Yb3+-activated silica-hafnia glass-ceramic films")

S. E. Amrani, M. Sun, S. Valdueza-Felip, F. B. Naranjo, M. R. Britel, M. Ferrari, A. Bouajaj

arXiv:2511.17114v1 Announce Type: new 
...
[27]. [*Single-Defect Spectroscopy via Random Telegraph Noise in Graphene-Contacted ReS$_2$-hBN Heterostructures*](https://arxiv.org/abs/2511.17125 "Single-Defect Spectroscopy via Random Telegraph Noise in Graphene-Contacted ReS$_2$-hBN Heterostructures")
...
arXiv:2511.17125v1 Announce Type: new 
...
[28]. [*Anyon Quasilocalization in a Quasicrystalline Toric Code*](https://arxiv.org/abs/2511.17144 "Anyon Quasilocalization in a Quasicrystalline Toric Code")

Soumya Sur, Mohammad Saad, Adhip Agarwala

arXiv:2511.17144v1 Announce Type: new 
...
[29]. [*Enhanced Efficiency of Intermediate-Band Semiconductor Solar Cells Embedded with Quantum Dot Superlattices*](https://arxiv.org/abs/2511.17151 "Enhanced Efficiency of Intermediate-Band Semiconductor Solar Cells Embedded with Quantum Dot Superlattices")

Naira Petrosyan, Lilit Yeganyan, Aram Manaselyan, Vram Mughnetsyan, Vidar Gudmundsson, Albert Kirakosyan

arXiv:2511.17151v1 Announce Type: new 
...
[30]. [*Probing Boundary Spins in the Su-Schrieffer-Heeger-Hubbard model*](https://arxiv.org/abs/2511.17173 "Probing Boundary Spins in the Su-Schrieffer-Heeger-Hubbard model")

Armando A. Aligia, Alejandro M. Lobos, Lucila Peralta Gavensky, Claudio J. Gazza

arXiv:2511.17173v1 Announce Type: new 
...
[31]. [*Tunable Kondo effect in a bilayer graphene quantum channel*](https://arxiv.org/abs/2511.17188 "Tunable Kondo effect in a bilayer graphene quantum channel")
...
arXiv:2511.17188v1 Announce Type: new 
...
[32]. [*Ferroelectric Switchable Topological Magnon Hall Effect in Type-I Multiferroics*](https://arxiv.org/abs/2511.17189 "Ferroelectric Switchable Topological Magnon Hall Effect in Type-I Multiferroics")

Quanchao Du, Jinlian Lu, Xueqing Wan, Zhenlong Zhang, Zhijun Jiang

arXiv:2511.17189v1 Announce Type: new 
...
[33]. [*Coexistence of unconventional spin-orbit torque and in-plane Hall effect in a single ferromagnetic layer*](https://arxiv.org/abs/2511.17231 "Coexistence of unconventional spin-orbit torque and in-plane Hall effect in a single ferromagnetic layer")

Jiaxin Chen, Hongsheng Zheng, Hongliang Chen, Qia Shen, Chang Pan, Zhenyi Zheng, Hemian Yi, Dandan Guan, Xiaoxue Liu, Yaoyi Li, Shiyong Wang, Hao Zheng, Canhua Liu, Jinfeng Jia, Jingsheng Chen, Ruidan Zhong, Lei Wang, Xuepeng Qiu, Yumeng Yang, Aur\'elien Manchon, Liang Liu

arXiv:2511.17231v1 Announce Type: new 
...
[34]. [*Simulated Annealing for Quadratic and Higher-Order Unconstrained Integer Optimization*](https://arxiv.org/abs/2511.17245 "Simulated Annealing for Quadratic and Higher-Order Unconstrained Integer Optimization")

Kohei Suzuki

arXiv:2511.17245v1 Announce Type: new 
...
[35]. [*Molecular insight on ultra-confined ionic transport in wetting films: the key role of friction*](https://arxiv.org/abs/2511.17257 "Molecular insight on ultra-confined ionic transport in wetting films: the key role of friction")

Aymeric Allemand, Anne-Laure Biance, Christophe Ybert, Laurent Joly

arXiv:2511.17257v1 Announce Type: new 
...
[40]. [*DoS Dos and Don'ts*](https://arxiv.org/abs/2511.17360 "DoS Dos and Don'ts")

Lucas Warwaruk, Konstantinos Zinelis, Randy H. Ewoldt, Christopher W. Macosko, Gareth H. McKinley

arXiv:2511.17360v1 Announce Type: new 
...
[41]. [*Critical BKT dynamics in the archetypal 2D spin system Ba$_2$CuSi$_2$O$_6$Cl$_2$*](https://arxiv.org/abs/2511.17381 "Critical BKT dynamics in the archetypal 2D spin system Ba$_2$CuSi$_2$O$_6$Cl$_2$")
...
arXiv:2511.17381v1 Announce Type: new 
...
[42]. [*Building 3D superconductor-based Josephson junctions using a via transfer approach*](https://arxiv.org/abs/2511.17386 "Building 3D superconductor-based Josephson junctions using a via transfer approach")
...
arXiv:2511.17386v1 Announce Type: new 
...
[43]. [*Non-Hermitian impurity problem*](https://arxiv.org/abs/2511.17390 "Non-Hermitian impurity problem")

E. T. Kokkinakis, I. Komis, K. G. Makris, E. N. Economou

arXiv:2511.17390v1 Announce Type: new 
...
[44]. [*Crystal Growth and Physical Properties of Orthorhombic Kagome Lattice Magnets $R$Fe$_6$Ge$_6$ ($R$=Y, Tb, Dy)*](https://arxiv.org/abs/2511.17398 "Crystal Growth and Physical Properties of Orthorhombic Kagome Lattice Magnets $R$Fe$_6$Ge$_6$ ($R$=Y, Tb, Dy)")
...
arXiv:2511.17398v1 Announce Type: new 
...
[45]. [*Momentum-Resolved Electronic Structure and Orbital Hybridization in the Layered Antiferromagnet CrPS$_4$*](https://arxiv.org/abs/2511.17403 "Momentum-Resolved Electronic Structure and Orbital Hybridization in the Layered Antiferromagnet CrPS$_4$")

Lasse Sternemann, David Maximilian Janas, Eshan Banerjee, Richard Leven, Jonah Elias Nitschke, Marco Marino, Leon Becker, Ahmet Can Ademo\u{g}lu, Frithjof Anders, Stefan Tappertzhofen, Mirko Cinchetti

arXiv:2511.17403v1 Announce Type: new 
...
[46]. [*Breakdown of chiral anomaly and emergent phases in Weyl semimetals under orbital magnetic fields*](https://arxiv.org/abs/2511.17412 "Breakdown of chiral anomaly and emergent phases in Weyl semimetals under orbital magnetic fields")

Faruk Abdulla, Anna Keselman, Daniel Podolsky

arXiv:2511.17412v1 Announce Type: new 
...
[47]. [*Measuring Anyonic Exchange Phases Using Two-Dimensional Coherent Spectroscopy*](https://arxiv.org/abs/2511.17420 "Measuring Anyonic Exchange Phases Using Two-Dimensional Coherent Spectroscopy")

Nico Kirchner, Wonjune Choi, Frank Pollmann

arXiv:2511.17420v1 Announce Type: new 
...
[48]. [*Flat band surface state superconductivity in thick rhombohedral graphene*](https://arxiv.org/abs/2511.17423 "Flat band surface state superconductivity in thick rhombohedral graphene")
...
arXiv:2511.17423v1 Announce Type: new 
...
[49]. [*Empirical universality and non-universality of local dynamics in the Sherrington-Kirkpatrick model*](https://arxiv.org/abs/2511.17428 "Empirical universality and non-universality of local dynamics in the Sherrington-Kirkpatrick model")

Grace Liu, Dmitriy Kunisky

arXiv:2511.17428v1 Announce Type: new 
...
[50]. [*Triple point in a cell fluid model with effective temperature-dependent attraction*](https://arxiv.org/abs/2511.17444 "Triple point in a cell fluid model with effective temperature-dependent attraction")

M. P. Kozlovskii, O. A. Dobush, R. V. Romanik, I. V. Pylyuk, M. A. Shpot

arXiv:2511.17444v1 Announce Type: new 
...
[51]. [*Origin of large topological Hall effect in the EuCd$_2$Sb$_2$ antiferromagnet*](https://arxiv.org/abs/2511.17445 "Origin of large topological Hall effect in the EuCd$_2$Sb$_2$ antiferromagnet")

Faheem Gul, Orest Pavlosiuk, Tetiana Romanova, Dariusz Kaczorowski, Piotr Wi\'sniewski

arXiv:2511.17445v1 Announce Type: new 
...
[52]. [*Minimalist machine-learned interatomic potentials can predict complex structural behaviors accurately*](https://arxiv.org/abs/2511.17449 "Minimalist machine-learned interatomic potentials can predict complex structural behaviors accurately")

I\~nigo Robredo-Magro, Binayak Mukherjee, Hugo Aramberri, Jorge \'I\~niguez-Gonz\'alez

arXiv:2511.17449v1 Announce Type: new 
...
[53]. [*Evolution of inhomogeneities in two-dimensional disordered superconductors in a magnetic field*](https://arxiv.org/abs/2511.17459 "Evolution of inhomogeneities in two-dimensional disordered superconductors in a magnetic field")

Poulami Sarkar, Jhinhwan Lee, Hae-Ryong Park, Anushree Dutta, Amit Ghosal

arXiv:2511.17459v1 Announce Type: new 
...
[54]. [*A path to high temperature superconductivity via strong short range repulsion in spin polarized band*](https://arxiv.org/abs/2511.17466 "A path to high temperature superconductivity via strong short range repulsion in spin polarized band")

Zhiyu Dong, Patrick A. Lee

arXiv:2511.17466v1 Announce Type: new 
...
[55]. [*Fast and Continuous Detection of Single Microwave Photons via Photo-assisted Quasiparticle Tunneling to a Superconducting Island*](https://arxiv.org/abs/2511.17470 "Fast and Continuous Detection of Single Microwave Photons via Photo-assisted Quasiparticle Tunneling to a Superconducting Island")

Julien Basset, Ognjen Stanisavljevi\'c, Julien Gabelli, Marco Aprili, J\'er\^ome Est\`eve

arXiv:2511.17470v1 Announce Type: new 
...
[56]. [*Thermalization of exact quantum many-body scars in spin-1 XY chain under perturbations*](https://arxiv.org/abs/2511.17476 "Thermalization of exact quantum many-body scars in spin-1 XY chain under perturbations")

Himadri Halder

arXiv:2511.17476v1 Announce Type: new 
...
[57]. [*Antagonistic impact of thermal expansion and phonon anharmonicity on the phonon-limited resistivity of elemental metals from first principles*](https://arxiv.org/abs/2511.17478 "Antagonistic impact of thermal expansion and phonon anharmonicity on the phonon-limited resistivity of elemental metals from first principles")

Ao Wang, Junwen Yin, F\'elix Antoine Goudreault, Michel C\^ot\'e, Olle Hellman, Samuel Ponc\'e

arXiv:2511.17478v1 Announce Type: new 
...
[58]. [*Frustration driven magnetic correlations in the spin-$5/2$ triangular lattice antiferromagnet RbFe(HPO$_{3}$)$_{2}$*](https://arxiv.org/abs/2511.17480 "Frustration driven magnetic correlations in the spin-$5/2$ triangular lattice antiferromagnet RbFe(HPO$_{3}$)$_{2}$")

V. Nagpal, Sebin J. Sebastian, Surya P. Patra, S. Shibash, Q. -P. Ding, Y. Furukawa, R. Nath

arXiv:2511.17480v1 Announce Type: new 
...
[59]. [*Efficient prediction of topological superlattice bands with spin-orbit coupling*](https://arxiv.org/abs/2511.17483 "Efficient prediction of topological superlattice bands with spin-orbit coupling")

M. Nabil Y. Lhachemi, Valentin Cr\'epel, Jennifer Cano

arXiv:2511.17483v1 Announce Type: new 
...
[60]. [*Fractional Chern insulator edges: crystalline effects and optical measurements*](https://arxiv.org/abs/2511.17494 "Fractional Chern insulator edges: crystalline effects and optical measurements")

Yan-Qi Wang, Johannes Motruk, Andrey Grankin, Mohammad Hafezi

arXiv:2511.17494v1 Announce Type: new 
...
[61]. [*Catalytic Resonance Theory: Kinetics and Frequency Response of Light-Promoted Catalysis*](https://arxiv.org/abs/2511.16701 "Catalytic Resonance Theory: Kinetics and Frequency Response of Light-Promoted Catalysis")

Paul J Dauenhauer

arXiv:2511.16701v1 Announce Type: cross 
...
[62]. [*Magnetically induced Josephson nano-diodes in field-resilient superconducting microwave circuits*](https://arxiv.org/abs/2511.16727 "Magnetically induced Josephson nano-diodes in field-resilient superconducting microwave circuits")

Benedikt Wilde, Mohamad Kazouini, Timo Kern, Kevin Uhl, Christoph F\"uger, Dieter Koelle, Reinhold Kleiner, Daniel Bothner

arXiv:2511.16727v1 Announce Type: cross 
...
[63]. [*Time Evolution of Multi-Party Entanglement Signals*](https://arxiv.org/abs/2511.16729 "Time Evolution of Multi-Party Entanglement Signals")

Vijay Balasubramanian, Hanzhi Jiang, Simon F. Ross

arXiv:2511.16729v1 Announce Type: cross 
...
[64]. [*Hybrid-spin decoupling for noise-resilient DC quantum sensing*](https://arxiv.org/abs/2511.16732 "Hybrid-spin decoupling for noise-resilient DC quantum sensing")

So Chigusa, Masashi Hazumi, Ernst David Herbschleb, Yuichiro Matsuzaki, Norikazu Mizuochi, Kazunori Nakayama

arXiv:2511.16732v1 Announce Type: cross 
...
[65]. [*Adiabatic reverse annealing is robust to low-temperature decoherence*](https://arxiv.org/abs/2511.16735 "Adiabatic reverse annealing is robust to low-temperature decoherence")

An Le, Christopher L. Baldwin

arXiv:2511.16735v1 Announce Type: cross 
...
[66]. [*Scalable Quantum Computational Science: A Perspective from Block-Encodings and Polynomial Transformations*](https://arxiv.org/abs/2511.16738 "Scalable Quantum Computational Science: A Perspective from Block-Encodings and Polynomial Transformations")

Kevin J. Joven, Elin Ranjan Das, Joel Bierman, Aishwarya Majumdar, Masoud Hakimi Heris, Yuan Liu

arXiv:2511.16738v1 Announce Type: cross 
...
[67]. [*Conserved quantities enable the quantum Mpemba effect in weakly open systems*](https://arxiv.org/abs/2511.16739 "Conserved quantities enable the quantum Mpemba effect in weakly open systems")

Iris Ul\v{c}akar, Rustem Sharipov, Gianluca Lagnese, Zala Lenar\v{c}i\v{c}

arXiv:2511.16739v1 Announce Type: cross 
...
[68]. [*EFT meets CFT: Multiloop renormalization of higher-dimensional operators in general $\boldsymbol{\phi^4}$ theories*](https://arxiv.org/abs/2511.16740 "EFT meets CFT: Multiloop renormalization of higher-dimensional operators in general $\boldsymbol{\phi^4}$ theories")

Johan Henriksson, Stefanos R. Kousvos, Jasper Roosmale Nepveu

arXiv:2511.16740v1 Announce Type: cross 
...
[69]. [*A permutation-based power series representation of the Baker-Campbell-Hausdorff formula*](https://arxiv.org/abs/2511.16790 "A permutation-based power series representation of the Baker-Campbell-Hausdorff formula")

Joseph M. Jones, M. W. Long

arXiv:2511.16790v1 Announce Type: cross 
...
[70]. [*Broadband telecom single-photon emissions from InAs/InP quantum dots grown by MOVPE droplet epitaxy*](https://arxiv.org/abs/2511.16894 "Broadband telecom single-photon emissions from InAs/InP quantum dots grown by MOVPE droplet epitaxy")

Shichen Zhang, Li Liu, Kai Guo, Xingli Mu, Yuanfei Gao, Junqi Liu, Fengqi Liu, Quanyong Lu, Zhiliang Yuan

arXiv:2511.16894v1 Announce Type: cross 
...
[71]. [*Spectroscopy on a single nonlinear mode recognizes quantum states*](https://arxiv.org/abs/2511.16945 "Spectroscopy on a single nonlinear mode recognizes quantum states")

Wouter Verstraelen, Stanis{\l}aw \'Swierczewski, Andrzej Opala, Andrew Haky, Matteo Gadani, Huawen Xu, Oleksandr Kyriienko, Micha{\l} Matuszewski, Alberto Bramati, Timothy C. H. Liew

arXiv:2511.16945v1 Announce Type: cross 
...
[72]. [*Quantum Jump Approach for Photosynthetic Energy Transfer with Chemical Reaction and Fluorescence Loss*](https://arxiv.org/abs/2511.16984 "Quantum Jump Approach for Photosynthetic Energy Transfer with Chemical Reaction and Fluorescence Loss")

Rui Li, Yi Li, Kai-Ya Zhang, Qing Ai

arXiv:2511.16984v1 Announce Type: cross 
...
[73]. [*The Scrooge ensemble in many-body quantum systems*](https://arxiv.org/abs/2511.17172 "The Scrooge ensemble in many-body quantum systems")

Max McGinley, Thomas Schuster

arXiv:2511.17172v1 Announce Type: cross 
...
[74]. [*Ferroelectric Nematic Liquid Crystals as Charge Boosters for Triboelectric Nanogenerators*](https://arxiv.org/abs/2511.17202 "Ferroelectric Nematic Liquid Crystals as Charge Boosters for Triboelectric Nanogenerators")

Jia-Yao Ye, Susanta Chakraborty, Karthick Subramani, Xing-Zhou Tang, Yan-Nan Xie, Bing-Xiang Li

arXiv:2511.17202v1 Announce Type: cross 
...
[75]. [*A Short Introduction to Metal Forming*](https://arxiv.org/abs/2511.17222 "A Short Introduction to Metal Forming")

Charbel Moussa, Pierre Montmitonnet

arXiv:2511.17222v1 Announce Type: cross 
...
[76]. [*Basic cell for a quantum microwave router*](https://arxiv.org/abs/2511.17250 "Basic cell for a quantum microwave router")

Evgeniya Mutsenik, Aidar Sultanov, Leonie Kaczmarek, Matthias Schmelz, Gregor Oelsner, Ronny Stolz, Evgeni Ilichev

arXiv:2511.17250v1 Announce Type: cross 
...
[77]. [*Aspects of quantum geometry in photonic time crystals*](https://arxiv.org/abs/2511.17317 "Aspects of quantum geometry in photonic time crystals")

Karthik Subramaniam Eswaran, Ali Emami Kopaei, Krzysztof Sacha

arXiv:2511.17317v1 Announce Type: cross 
...
[78]. [*Robust detection of an entanglement transition in the projective transverse field Ising model*](https://arxiv.org/abs/2511.17370 "Robust detection of an entanglement transition in the projective transverse field Ising model")

Felix Roser, Etienne M. Springer, Hans Peter B\"uchler, Nicolai Lang

arXiv:2511.17370v1 Announce Type: cross 
...
[79]. [*Circulation of Elites in an Adaptive Network Model*](https://arxiv.org/abs/2511.17434 "Circulation of Elites in an Adaptive Network Model")

Alexander Jochim, Stefan Bornholdt

arXiv:2511.17434v1 Announce Type: cross 
...
[80]. [*Local equations for the generalized Lotka-Volterra model on sparse asymmetric graphs*](https://arxiv.org/abs/2511.17499 "Local equations for the generalized Lotka-Volterra model on sparse asymmetric graphs")

David Machado, Pietro Valigi, Tommaso Tonolo, Maria Chiara Angelini

arXiv:2511.17499v1 Announce Type: cross 
...
[81]. [*Noise Electrometry of Polar and Dielectric Materials*](https://arxiv.org/abs/2111.09315 "Noise Electrometry of Polar and Dielectric Materials")
...
arXiv:2111.09315v2 Announce Type: replace 
...
[84]. [*Validity of the Fr\"ohlich model for a mobile impurity in a Bose-Einstein condensate*](https://arxiv.org/abs/2411.11655 "Validity of the Fr\"ohlich model for a mobile impurity in a Bose-Einstein condensate")

Jonas Lampart, Arnaud Triay

arXiv:2411.11655v3 Announce Type: replace 
...
[85]. [*Efficient Spin Transfer in WTe2/Fe3GeTe2 van der Waals Heterostructure Enabled by Direct Interlayer p-Orbital Hybridization*](https://arxiv.org/abs/2412.02966 "Efficient Spin Transfer in WTe2/Fe3GeTe2 van der Waals Heterostructure Enabled by Direct Interlayer p-Orbital Hybridization")

H. L. Ning, M. Q. Dong, X. Zhang, J. S. Huang, B. Liu, Zhi-Xin Guo, Y. Dong

arXiv:2412.02966v2 Announce Type: replace 
...
[86]. [*Statistical physics analysis of graph neural networks: Approaching optimality in the contextual stochastic block model*](https://arxiv.org/abs/2503.01361 "Statistical physics analysis of graph neural networks: Approaching optimality in the contextual stochastic block model")

O. Duranthon, L. Zdeborov\'a

arXiv:2503.01361v3 Announce Type: replace 
...
arXiv:2505.15012v3 Announce Type: replace 
...
[89]. [*A General Approach to the Shape Transition of Run-and-Tumble Particles: The 1D PDMP Framework for Invariant Measure Regularity*](https://arxiv.org/abs/2506.02274 "A General Approach to the Shape Transition of Run-and-Tumble Particles: The 1D PDMP Framework for Invariant Measure Regularity")

Leo Hahn

arXiv:2506.02274v3 Announce Type: replace 
...
[93]. [*Impact of electronic correlations on the superconductivity of high-pressure CeH$_9$*](https://arxiv.org/abs/2507.12506 "Impact of electronic correlations on the superconductivity of high-pressure CeH$_9$")

Siyu Chen, Yao Wei, Bartomeu Monserrat, Jan M. Tomczak, Samuel Ponc\'e

arXiv:2507.12506v2 Announce Type: replace 
...
[94]. [*External magnetic field suppression of carbon diffusion in iron*](https://arxiv.org/abs/2507.16090 "External magnetic field suppression of carbon diffusion in iron")
...
[96]. [*Re-entrant unconventional superconductivity induced by rare-earth substitution in Nd1-xEuxNiO2 thin films*](https://arxiv.org/abs/2508.15968 "Re-entrant unconventional superconductivity induced by rare-earth substitution in Nd1-xEuxNiO2 thin films")

Dung Vu, Hangoo Lee, Daniele Nicoletti, Wenzheng Wei, Zheting Jin, Dmitry V. Chichinadze, Michele Buzzi, Wenxin Li, Xinhao Yang, Rongting Wu, Christopher A. Mizzi, Tiema Qian, Boris Maiorov, Alexey Suslov, Yu He, Cyprian Lewandowski, Sohrab Ismail-Beigi, Frederick Walker, Andrea Cavalleri, Charles Ahn

arXiv:2508.15968v2 Announce Type: replace 
...
[97]. [*Speeding up Brownian escape via intermediate finite potential barriers*](https://arxiv.org/abs/2509.03449 "Speeding up Brownian escape via intermediate finite potential barriers")

Vishwajeet Kumar, Ohad Shpielberg, Arnab Pal

arXiv:2509.03449v2 Announce Type: replace 
...
arXiv:2509.03572v2 Announce Type: replace 
...
[99]. [*Domain Boundaries in a Metallic Distortive Polar Metal*](https://arxiv.org/abs/2509.23831 "Domain Boundaries in a Metallic Distortive Polar Metal")
...
[101]. [*On the supra-linear storage in dense networks of grid and place cells*](https://arxiv.org/abs/2511.02441 "On the supra-linear storage in dense networks of grid and place cells")

Adriano Barra, Martino S. Centonze, Michela Marra Solazzo, Daniele Tantari

arXiv:2511.02441v2 Announce Type: replace 
...
[102]. [*Electrical conductivity of randomly placed linear wires: a mean field approach*](https://arxiv.org/abs/2511.07021 "Electrical conductivity of randomly placed linear wires: a mean field approach")

Yuri Yu. Tarasevich, Andrei V. Eserkepov, Irina V. Vodolazskaya

arXiv:2511.07021v2 Announce Type: replace 
...
[103]. [*Accelerated Prediction of Temperature-Dependent Lattice Thermal Conductivity via Ensembled Machine Learning Models*](https://arxiv.org/abs/2511.13202 "Accelerated Prediction of Temperature-Dependent Lattice Thermal Conductivity via Ensembled Machine Learning Models")

Piyush Paliwal, Aftab Alam

arXiv:2511.13202v3 Announce Type: replace 
...
[104]. [*Pressure-Induced B1 to B2 Phase Transition in CeN Studied by ab initio Correlation Matrix Renormalization Theory Calculations*](https://arxiv.org/abs/2511.14085 "Pressure-Induced B1 to B2 Phase Transition in CeN Studied by ab initio Correlation Matrix Renormalization Theory Calculations")

Jun Liu, Jianhua Zhang, Yongxin Yao, Kai-Ming Ho, Cai-Zhuang Wang

arXiv:2511.14085v2 Announce Type: replace 
...
[105]. [*Moir\'e-induced gapped phases in twisted nodal superconductors*](https://arxiv.org/abs/2511.15708 "Moir\'e-induced gapped phases in twisted nodal superconductors")

Kevin P. Lucht, J. H. Pixley, Pavel A. Volkov

arXiv:2511.15708v2 Announce Type: replace 
...
[106]. [*Noise-induced resonant acceleration of a charge in an intermittent magnetic field: an exact solution for ergodic and non-ergodic fluctuations*](https://arxiv.org/abs/2511.15939 "Noise-induced resonant acceleration of a charge in an intermittent magnetic field: an exact solution for ergodic and non-ergodic fluctuations")

Gerardo Aquino, Mauro Bologna

arXiv:2511.15939v2 Announce Type: replace 
...
[107]. [*Neural optimization of the most probable paths of 3D active Brownian particles*](https://arxiv.org/abs/2511.16178 "Neural optimization of the most probable paths of 3D active Brownian particles")
...
arXiv:2511.16178v2 Announce Type: replace 
...
[108]. [*Quasiparticle states of hexagonal BN: A van der Waals density functional study*](https://arxiv.org/abs/2511.16313 "Quasiparticle states of hexagonal BN: A van der Waals density functional study")

Raul Quintero-Monsebaiz, Per Hyldgaard

arXiv:2511.16313v2 Announce Type: replace 
...
[109]. [*The critical O(N) CFT: Methods and conformal data*](https://arxiv.org/abs/2201.09520 "The critical O(N) CFT: Methods and conformal data")

Johan Henriksson

arXiv:2201.09520v4 Announce Type: replace-cross 
Abstract: The critical $O(N)$ CFT in spacetime dimensions $2 < d < 4$ is one of the most important examples of a conformal field theory, with the Ising CFT at $N=1$, $2 \leq d < 4$, as a notable special case. Apart from numerous physical applications, it serves frequently as a concrete testing ground for new approaches and techniques based on conformal symmetry. In the perturbative limits - the $4-\varepsilon$ expansion, the large $N$ expansion and the $2+\tilde\epsilon$ expansion - a lot of conformal data have been computed over the years. In this report, we give an overview of the critical $O(N)$ CFT, including some methods to study it, and present a large collection of conformal data. The data, extracted from the literature and supplemented by many additional computations of order $\varepsilon$ anomalous dimensions, are made available through an ancillary data file.



[110]. [*Estimating Global Input Relevance and Enforcing Sparse Representations with a Scalable Spectral Neural Network Approach*](https://arxiv.org/abs/2406.01183 "Estimating Global Input Relevance and Enforcing Sparse Representations with a Scalable Spectral Neural Network Approach")
...
[111]. [*Entanglement behavior and localization properties in monitored fermion systems*](https://arxiv.org/abs/2502.09401 "Entanglement behavior and localization properties in monitored fermion systems")

Giulia Piccitto, Giuliano Chiriac\`o, Davide Rossini, Angelo Russomanno

arXiv:2502.09401v2 Announce Type: replace-cross 
...
[112]. [*Topological Phase Transition and Geometrical Frustration in Fourier Photonic Simulator*](https://arxiv.org/abs/2503.24363 "Topological Phase Transition and Geometrical Frustration in Fourier Photonic Simulator")

Yuxuan Sun, Weiru Fan, Xingqi Xu, Da-Wei Wang, Hai-Qing Lin

arXiv:2503.24363v3 Announce Type: replace-cross 
...
[113]. [*Transfer of quantum-enhanced information through a many-body system*](https://arxiv.org/abs/2504.16994 "Transfer of quantum-enhanced information through a many-body system")

Piotr Wysocki, Marcin P{\l}odzie\'n, Jan Chwede\'nczuk

arXiv:2504.16994v2 Announce Type: replace-cross 
...
[114]. [*High-temperature partition functions and classical simulatability of long-range quantum systems*](https://arxiv.org/abs/2504.20901 "High-temperature partition functions and classical simulatability of long-range quantum systems")

Jorge S\'anchez-Segovia, Jan T. Schneider, \'Alvaro M. Alhambra

arXiv:2504.20901v2 Announce Type: replace-cross 
...
[115]. [*Nuclear Spin-Mediated Relaxation Mechanisms of the V$_{B}^-$ Center in hBN*](https://arxiv.org/abs/2507.11494 "Nuclear Spin-Mediated Relaxation Mechanisms of the V$_{B}^-$ Center in hBN")

Chanaprom Cholsuk, Tobias Vogl, Viktor Iv\'ady

arXiv:2507.11494v2 Announce Type: replace-cross 
...
[118]. [*Genuine multi-entropy, dihedral invariants and Lifshitz theory*](https://arxiv.org/abs/2509.00593 "Genuine multi-entropy, dihedral invariants and Lifshitz theory")

Cl\'ement Berthi\`ere, Paul Gaudin

arXiv:2509.00593v2 Announce Type: replace-cross 
Abstract: Multi-invariants are local-unitary invariants of state replicas introduced as potential probes of multipartite entanglement and correlations in quantum many-body systems. In this paper, we investigate two multi-invariants for tripartite pure states, namely multi-entropy and dihedral invariant. We compute the (genuine) multi-entropy for Lifshitz groundstates, and obtain its analytical continuation to noninteger values of R\'enyi index. We show that the genuine multi-entropy can be expressed in terms of mutual information and logarithmic negativity, a relation that also holds for stabilizer states. For general tripartite pure states, we demonstrate that dihedral invariants are related to R\'enyi reflected entropies. In particular, we show that the dihedral permutations of replicas are equivalent to the reflected construction, or alternatively to the realignment of density matrices.



[119]. [*Theory for the spectral splitting exponent of exceptional points*](https://arxiv.org/abs/2509.02174 "Theory for the spectral splitting exponent of exceptional points")

Shu-Xuan Wang, Zhongbo Yan

arXiv:2509.02174v2 Announce Type: replace-cross 
...
[120]. [*How LLMs Learn to Reason: A Complex Network Perspective*](https://arxiv.org/abs/2509.23629 "How LLMs Learn to Reason: A Complex Network Perspective")
...
[121]. [*From single-particle to many-body chaos in Yukawa--SYK: theory and a cavity-QED proposal*](https://arxiv.org/abs/2511.04762 "From single-particle to many-body chaos in Yukawa--SYK: theory and a cavity-QED proposal")

David Pascual Solis, Alex Windey, Soumik Bandyopadhyay, Andrea Legramandi, Philipp Hauke

arXiv:2511.04762v2 Announce Type: replace-cross 
